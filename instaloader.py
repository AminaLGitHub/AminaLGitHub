#Source: https://github.com/instaloader/instaloader/blob/master/instaloader
#Additional Steps:
#1. When creating this file, strictly name it instaloader.py
#2. Create files for all classes (exceptions, instaloadercontext, lateststamps, nodeiterator, sectioniterator); strictly name files by class name, i.e. exceptions.py
#3. Additionally, create files for __main__ and __init__; strictly name files accordingly
